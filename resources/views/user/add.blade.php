                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <div class="input-group">
                                        ...
                                        <label for="form_control_1"><span class="required"> * </span></label>
                                        <span class="input-group-addon">
                                            <i class="fa fa-envelope"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="que_quan" value="{{ old('que_quan') }}">
                                        <label for="form_control_1">Quê Quán  <span class="required"> * </span></label>
                                        <span class="input-group-addon">
                                            <i class="fa fa-envelope"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <div class="input-group">
                                        <input type="float" class="form-control" name="luong" value="{{ old('luong') }}">
                                        <label for="form_control_1">Lương<span class="required"> * </span></label>
                                        <span class="input-group-addon">
                                            <i class="fa fa-envelope"></i>
                                        </span>
                                    </div>
